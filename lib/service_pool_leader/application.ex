defmodule ServicePoolLeader.Application do
  ...
  def start(_type, _args) do
    ...
    # Using :rest_for_one, if a Coordinator goes down, restart the tracked
    # service. When it starts, it re-registers with the Coordinator.
    opts = [strategy: :rest_for_one, name: ServicePoolLeader.Supervisor]
